...
// Module: masterpro  <-- replace with: user-hub | writemuse | masterpro | course-hub | hrl-community | hrl-sync-hub
...
//        and replace masterpro with the appropriate module slug above.

const MODULE_URL = (import.meta.env.VITE_ACCESS_MANAGER_URL as string)
  .replace("hrl-access", "masterpro");
